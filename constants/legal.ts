...
export const legalDocuments: Record<LegalDocumentKey, LegalDocument> = {
  terms: {
    ...
    subtitle: 'Professional terms for using PromptFund.',
    preview: 'Rules governing the use of PromptFund.',
    lastUpdated: 'Jun 2026',
    readingTimeMinutes: 5,
    sections: [
      { title: 'Acceptance', body: 'By creating an account or using PromptFund, you agree to these Terms of Service and all policies referenced in the app.' },
      { title: 'Eligibility', body: 'PromptFund is intended for users who can legally enter binding agreements and participate in founder or angel investor discussions under applicable law.' },
      { title: 'Accounts', body: 'You are responsible for keeping your account information accurate, securing your credentials, and using PromptFund only for lawful professional purposes.' },
      ...
      { title: 'Investment Discussions', body: 'PromptFund facilitates introductions and private discussions. Discussions are not offers, solicitations, guarantees, or investment advice from PromptFund.' },
      { title: 'Messaging', body: 'Messaging must remain professional, accurate, and lawful. PromptFund may moderate abusive, fraudulent, or unsafe activity.' },
      ...
      { title: 'Community Rules', body: 'You must follow PromptFund Community Guidelines and avoid harassment, spam, scams, false claims, and unlawful fundraising activity.' },
      ...
      { title: 'Reporting', body: 'Users may report unsafe behavior. Reports are reviewed by PromptFund Trust & Safety and may result in moderation action.' },
      { title: 'Intellectual Property', body: 'PromptFund owns its platform, branding, design, and software. Users retain rights in their submitted content but grant PromptFund permission to host and process it to provide the service.' },
      ...
      { title: 'Platform Availability', body: 'PromptFund may change, suspend, or discontinue features and cannot guarantee uninterrupted platform availability.' },
      { title: 'Disclaimer', body: 'PromptFund is provided as-is and does not guarantee fundraising outcomes, investment performance, legal compliance, or counterparty reliability.' },
      { title: 'Limitation of Liability', body: 'To the fullest extent allowed by law, PromptFund is not liable for indirect, incidental, special, consequential, or investment-related losses arising from platform use.' },
      { title: 'Governing Law', body: 'These terms are governed by the laws applicable to PromptFund operations, without regard to conflict-of-law rules.' },
      { title: 'Contact', body: 'Contact PromptFund support for questions about these Terms of Service or platform use.' },
    ],
  },
  privacy: {
    key: 'privacy',
    title: 'Privacy Policy',
    subtitle: 'How PromptFund handles account, investment, and safety data.',
    preview: 'Learn how we collect and protect your information.',
    lastUpdated: 'Jun 2026',
    readingTimeMinutes: 4,
    sections: [
      { title: 'Information Collected', body: 'PromptFund collects account information, profile details, role selections, startup information, investment discussion records, safety reports, and app activity needed to provide the platform.' },
      ...
      { title: 'Images', body: 'Images such as profile photos, startup visuals, and chat attachments are stored and served through PromptFund infrastructure.' },
      ...
      { title: 'Firebase', body: 'PromptFund uses Firebase services for authentication, Firestore records, file storage, notifications, and related infrastructure.' },
      { title: 'Storage', body: 'Uploaded files may be stored in Firebase Storage and linked to private discussion or profile records.' },
      { title: 'Analytics', body: 'PromptFund may use operational analytics to understand reliability, usage, safety, and product performance.' },
      { title: 'Security', body: 'PromptFund uses access controls and security rules to limit data access to authorized users, but no system can be guaranteed perfectly secure.' },
      { title: 'Retention', body: 'PromptFund retains account, discussion, agreement, safety, and transaction-related records as needed for platform operation, compliance, dispute resolution, and legitimate business purposes.' },
      ...
      { title: 'Contact', body: 'Contact PromptFund support for privacy questions or requests.' },
    ],
  },
  community: {
    key: 'community',
    ...
    sections: [
      ...
      { title: 'No Illegal Fundraising', body: 'Do not use PromptFund to conduct unlawful securities activity, evade legal requirements, or mislead counterparties.' },
  ...
  investmentDisclaimer: {
    ...
    subtitle: 'Important limits on PromptFund’s role.',
    preview: 'Important information before investing.',
    lastUpdated: 'Jun 2026',
    readingTimeMinutes: 3,
    sections: [
      { title: 'PromptFund Is Not a Broker', body: 'PromptFund is not a broker, securities exchange, financial advisor, or investment advisor.' },
      { title: 'No Guarantees', body: 'PromptFund never guarantees investments, fundraising outcomes, company performance, liquidity, or returns.' },
      ...
      { title: 'User Decisions', body: 'All investment decisions are made by users. PromptFund does not recommend, endorse, or approve any startup or investor.' },
    ],
  },
  aiDisclosure: {
    key: 'aiDisclosure',
    ...
    preview: 'Understand how AI is used inside PromptFund.',
    lastUpdated: 'Jun 2026',
  ...
  responsibilities: {
    ...
    sections: [
      ...
      { title: 'Shared Responsibilities', body: 'Both sides must use PromptFund in good faith, protect confidential information, avoid abusive behavior, and understand that investment decisions remain their own responsibility.' },
    ],
  },
};
